# Emergency-Audio-Recorder

This is a simple implementation of emergency audio streaming. Any and all audio streamed is recorded and saved securely on a server.
